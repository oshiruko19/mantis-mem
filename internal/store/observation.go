...
func (s *Store) SaveObservation(o *Observation) (saved *Observation, updated bool, err error) {
	...
	if strings.TrimSpace(o.TopicKey) == "" {
		const q = `
INSERT INTO observations(project_id, session_id, topic_key, kind, title, body, files, tags)
VALUES(?, ?, NULL, ?, ?, ?, ?, ?)
RETURNING id, project_id, session_id, COALESCE(topic_key,''), kind, title, body, files, tags, created_at, updated_at;`
		row := s.db.QueryRow(q, o.ProjectID, o.SessionID, o.Kind, o.Title, o.Body, files, o.Tags)
...
RETURNING id, project_id, session_id, COALESCE(topic_key,''), kind, title, body, files, tags, created_at, updated_at;`
	row := tx.QueryRow(q, o.ProjectID, o.SessionID, o.TopicKey, o.Kind, o.Title, o.Body, files, o.Tags)
	saved, err = scanObservation(row)
	if err != nil {
...
func (s *Store) GetObservation(id int64) (*Observation, error) {
	const q = `
SELECT id, project_id, session_id, COALESCE(topic_key,''), kind, title, body, files, tags, created_at, updated_at
...
func scanObservation(sc scanner) (*Observation, error) {
	...
	var files string
	if err := sc.Scan(
		&o.ID, &o.ProjectID, &o.SessionID, &o.TopicKey, &o.Kind,
